        ...
        <div class="row">
          <div class="col-md-12 chat-header bg-white rounded-top p-2">
            <div class="form-group row">
              <label class="control-label col-md-6">Pilih Nama Mahasiswa</label>
              <div class="col-md-12">
                <select id="pilihMahasiswa" class="form-control">
            ...
            <div class="row">
              ...
              <div class="col-md-5 user-detail pt-2">
                <h6 class="pt-1" id="mahasiswaName"><?php echo $dosen->name ?></h6>
            ...
            <div class="msg-box p-2">
              <div class="row">
                <form class="col-lg-12" id="form_pesan" method="POST">
                  <div class="row">
                    <div class="col-md-10">
                      <input type="hidden" name="user" id="user" value="<?php echo $dosen->user_id ?>" class="form-control">
...
<script>
  ...
  $("#pilihMahasiswa").change(function() {
    $('#target').val($(this).val())
    $('#mahasiswaName').text($("#pilihMahasiswa option:selected").text())
  })
</script>