...
const flashDataPengajuan = $('.flashdatapengajuan').data('flashdatapengajuan');
const jud = 'Pengajuan Judul';

if (flashDataPengajuan) {
	Swal.fire({
		title: 'Data ' + jud,
		text: 'Berhasil ' + flashDataPengajuan,
		type: 'success'
...
// tombol-hapus
$('.tombol-hapusta').on('click', function (e) {

	e.preventDefault();
	const href = $(this).attr('href');
	Swal.fire({
		title: 'Apakah anda yakin?',
		text: "Data " + datata + " akan dihapus!",
		type: 'warning',
		showCancelButton: true,
		confirmButtonColor: '#3085d6',
		cancelButtonColor: '#d33',
