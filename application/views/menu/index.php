                    ...
                    <tbody>
                        ...
                        <?php foreach ($menu as $m) : ?>
                            <tr>
                                ...
                                <td><?= $m['menu']; ?></td>
                                <td>
                                    <a href="" class="btn btn-success" data-toggle="modal" data-target="#editMenuModal<?= $m['id']; ?>">edit</a>
                                    ...
                                    <a href="" class="btn btn-danger" data-toggle="modal" data-target="#hapusMenuModal<?= $m['id']; ?>">Hapus</a>
